...
- `reports/figures/` — all pipeline figures including site comparison, optimization,
  soiling, ML, inverter screening, and ground-vs-CAMS validation plots.

## Related docs

- [PRODUCT.md](PRODUCT.md) — deliverable overview and run instructions
- [DATA_DICTIONARY.md](DATA_DICTIONARY.md) — column definitions and units
- [PROJECT_PLAN.md](PROJECT_PLAN.md) — work-package map
